...
answer 1: No, x and y re opposite of what they say.
Console.log(y) - Print an error because  y isn’t in scope.
Console.log (x) - Print “I’m a local variable” because x was defined within the outter function’s scope.
...
/*************************************************************************************
answer 2: Console.log(x) - x is undefined. It’s been declared by hoisting, but undefined.
...
//Date() always returns today's date
...
/**************************************************************************************
4
because it's a global function
...
(function(){
  ...
  var birthday = d.toDateString(1983, 3, 21);
  var bdayMsg("You were born on"); {
    return "You were born on " + toDateString());
  }
